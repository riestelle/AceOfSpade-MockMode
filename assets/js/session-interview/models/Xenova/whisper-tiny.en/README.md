# Xenova/whisper-tiny.en — local model bundle
#
# These files are served by the web server so the browser loads the Whisper
# speech-recognition model without downloading it from HuggingFace at runtime.
#
...
#   onnx/decoder_model_merged_quantized.onnx  (~19 MB)
#
